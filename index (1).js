...
function renderPassHistory(){
  ...
  list.innerHTML = passHistory.map((item, i) => `
    <div style="display:flex;flex-direction:column;gap:4px;padding:7px 8px;border-radius:8px;
      ...
      <div style="display:flex;align-items:center;gap:6px">
        ...
        <span style="font-size:.68rem;color:var(--tx3);flex-shrink:0;white-space:nowrap">🕐 ${timeAgo(item.ts)}</span>
      </div>
